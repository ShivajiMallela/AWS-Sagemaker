...
s3_path = 's3://hugging-face-textclassification/training_data/newsCorpora.csv'
...
class NewsDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        input = self.tokenizer.encode_plus(title,
                                            None, 
...
class DistilBERTClass(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.l1 = DistilBertModel.from_pretrained('distilbert-case-uncased')
